...
%plotOverview(gt, plotValues, finals);

% pv18 = makeDisplayValues(gv18);

plotOverview(gt, makeDisplayValues(gv18)', finals18);
plotOverview(gt, makeDisplayValues(gv20)', finals20);
plotOverview(gt, makeDisplayValues(gv22)', finals22);
