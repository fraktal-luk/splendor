...
if true
    ...
    [gv18, revS18] = diffuseValuesQuick(recValues18, followerMat, moves, finals18);
    
        recValues20 = nan(1, nStates);
        recValues20(finals20) = diffVector(finals20);
        
        [gv20, revS20] = diffuseValuesQuick(recValues20, followerMat, moves, finals20);
    
        
        recValues22 = nan(1, nStates);
        recValues22(finals22) = diffVector(finals22);
        
        [gv22, revS22] = diffuseValuesQuick(recValues22, followerMat, moves, finals22);
    
    
        recValues24 = nan(1, nStates);
        recValues24(finals24) = diffVector(finals24);
        
        [gv24, revS24] = diffuseValuesQuick(recValues24, followerMat, moves, finals24);
